    ...
    <div className="min-h-screen bg-[#FFFFFF] text-[#222222] font-sans pb-32">
      ...
      <header className="sticky top-0 z-50 bg-[#FFFFFF]/80 backdrop-blur-md border-b border-border">
        <div className="mx-auto w-full max-w-screen-xl px-6 py-4 flex items-center justify-between relative">
          <Link
            href="/"
            className="flex items-center gap-2 text-[#222222] hover:text-primary transition-colors"
          >
      ...
      <main className="mx-auto w-full max-w-screen-xl px-6 py-10">
        ...
        <section className="mb-12">
          <div className="bg-muted/30 rounded-3xl p-10 flex flex-col items-center text-center border border-border/50">
            <h2 className="text-2xl font-black tracking-tight text-[#222222] leading-tight mb-3">
              {t("goods.heroTitle")}
            </h2>
            <p className="text-base font-medium text-[#555555]">{t("goods.heroSubtitle")}</p>
          </div>
        </section>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="flex items-center gap-1 text-[13px]">
                      <Star
                        className="w-3.5 h-3.5 fill-[#FF385C] text-[#FF385C]"
                        strokeWidth={1.5}
                      />
                  ...
                  <h4 className="text-lg font-bold tracking-tight text-[#222222] mb-1 line-clamp-1">
                    {item.title}
                  </h4>
                  <p className="text-sm font-medium text-[#555555] mb-2 line-clamp-2 leading-relaxed">
                    {item.description}
                  </p>
                </div>
              </Link>
