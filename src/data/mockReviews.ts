...
export const MOCK_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    location_ja: "青沙浦ダリットル展望台",
    location_zh_CN: "青沙浦踏石观景台",
    spotId: "spot_001",
  ...
  },
  {
    ...
    location_ja: "ヒンヨウル文化村",
    location_zh_CN: "白浅滩文化村",
    spotId: "spot_004",
  ...
  },
  {
    ...
    content_ja: "広安大橋の夜景は毎回本当に息をのむ美しさです！マーベルファンとして、『ブラックパンサー』の壮大なチェイスシーンの背景がここだと知って胸が高鳴りました。海沿いには素敵なオーシャンビューカフェがたくさんあり、輝く橋を眺めながらコーヒーを飲むのは最高です。毎週土曜の夜のドローンショーに合わせて訪問することを強くおすすめします！",
    content_zh_CN: "每次看到广安大桥的夜景都忍不住惊叹！身为漫威迷，知道这里就是《黑豹》里那场华丽追逐战的背景，心脏都跟着狂跳。海滩边有很多氛围很好的海景咖啡厅，透过玻璃窗看着闪烁的广安大桥喝杯咖啡，简直就像在天堂一样。强烈建议在每周六晚上来，刚好可以看精彩的无人机表演！",
    likes: 412,
    category: "reviews",
  ...
  },
  {
    ...
    location_ja: "海雲台ブルーラインパーク",
    location_zh_CN: "海云台蓝线公园",
    spotId: "spot_001",
    image: "",
    content:
  ...
  },
  {
    ...
    content_ja: "青沙浦ダリットル展望台に行ってきました。写真より実物の方がはるかに綺麗です。超おすすめ！",
    content_zh_CN: "我去了青沙浦踏石观景台。亲眼看比照片还要漂亮很多。强烈推荐！",
    likes: 0,
    category: "reviews",
...
export function getLocalizedField(item: any, field: string, lang: string) {
  if (lang === "en" && item[field + "_en"]) return item[field + "_en"];
  if (lang === "zh-TW" && item[field + "_zh_TW"]) return item[field + "_zh_TW"];
  if (lang === "zh-CN" && item[field + "_zh_CN"]) return item[field + "_zh_CN"];
