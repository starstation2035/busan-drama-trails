...
const dicts = {
  'en': {
    ...
    modal: { title: 'New Post', subtitle: 'What story do you want to share?', category: 'Category', details: 'Details', photo: 'Attach Photo', clear: 'Clear', changePhoto: 'Change Photo', addPhoto: 'Click to add photo', location: 'Location Tag (Optional)', cancel: 'Cancel', submit: 'Post' },
  ...
  'ko': {
    ...
    modal: { title: '새 글 쓰기', subtitle: '어떤 이야기를 나누고 싶으신가요?', category: '글 분류', details: '내용', photo: '사진 첨부', clear: '지우기', changePhoto: '사진 변경', addPhoto: '클릭해서 사진 추가하기', location: '장소 태그 (선택)', cancel: '취소', submit: '작성 완료' },
  ...
  'ja': {
    ...
    modal: { title: '新規投稿', subtitle: 'どんな物語を共有したいですか？', category: 'カテゴリー', details: '詳細', photo: '写真を添付', clear: 'クリア', changePhoto: '写真を変更', addPhoto: 'クリックして写真を追加', location: '場所タグ (任意)', cancel: 'キャンセル', submit: '投稿' },
  ...
  'zh-CN': {
    ...
    modal: { title: '撰写新文章', subtitle: '想分享什么故事呢？', category: '文章分类', details: '内容', photo: '附上照片', clear: '清除', changePhoto: '更换照片', addPhoto: '点击添加照片', location: '打卡地点 (选填)', cancel: '取消', submit: '发布' },
  ...
  'zh-TW': {
    ...
    modal: { title: '撰寫新文章', subtitle: '想分享什麼故事呢？', category: '文章分類', details: '內容', photo: '附上照片', clear: '清除', changePhoto: '更換照片', addPhoto: '點擊新增照片', location: '打卡地點 (選填)', cancel: '取消', submit: '發布' },
